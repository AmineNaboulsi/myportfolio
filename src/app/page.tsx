    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about">
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <h2 className="text-xl font-bold text-[#BFE241]">About</h2>
        </BlurFade>
      ...
      <section id="education">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 7}>
            <h2 className="text-xl font-bold text-[#BFE241]">Education</h2>
          </BlurFade>
          {DATA.education.map((education, id) => (
            ...
            >
              <ResumeCard
                ...
                period={education.start==undefined ? `${education.end}` : `${education.start} - ${education.end}`}
              />
            </BlurFade>
          ))}
        </div>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-[#BFE241] text-background px-3 py-1 text-sm ">
                  My Projects
                </div>
